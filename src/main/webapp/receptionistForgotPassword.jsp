...
<html lang="en">
  <head>
    ...
    <title>Medicare - Receptionist Forgot Password</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <section class="appointment-section">
      <div class="form-container">
        <h2>Update Receptionist Password</h2>

        <form action="receptionist" method="post">
          <div class="form-group">
            <label for="phone">Receptionist Email:</label>
            <input
              type="email"
              id="phone"
              name="recepEmail"
          ...
          <div class="form-group">
            <label for="phone">Receptionist Password:</label>
            <input
              type="password"
              id="phone"
              name="recepPassword"
          ...
          <div class="form-group">
            <label for="phone">Confirm Receptionist Password:</label>
            <input
              type="password"
              id="phone"
              name="recepConfirmPass"
              placeholder="Confirm Receptionist Password"
              required
            />
          </div>

          <button type="submit" name="receptionistForgotPass" class="submit-btn">Submit</button>
        </form>
      </div>
    </section>
