...
<html lang="en">
  <head>
    ...
    <title>Medicare - Doctor Forgot Password</title>
    <link
      rel="stylesheet"
    ...
    <nav class="navbar">
      ...
      <div class="patient-info">
        <% if (session.getAttribute("docName") != null) {%>
						<i class="fa fa-user-circle" aria-hidden="true"><a href="" class="patient-name"></i><%=session.getAttribute("docName")%></a>
						<%}%>
      </div>
    </nav>
    ...
    <section class="appointment-section">
      <div class="form-container">
        ...
        <form action="doctor" method="post">
          ...
          <button type="submit" name="doctorForgotPass" class="submit-btn">Submit</button>
        </form>
      </div>
    </section>
