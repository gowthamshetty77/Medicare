...
<html lang="en">
  <head>
    ...
    <title>Medicare - Patient Forgot Password</title>
    <link
      rel="stylesheet"
    ...
    <nav class="navbar">
      ...
      <div class="patient-info">
        <% if (session.getAttribute("patName") != null) {%>
						<i class="fa fa-user-circle" aria-hidden="true"><a href="" class="patient-name"></i><%=session.getAttribute("patName")%></a>
						<%}%>
      </div>
    </nav>
    ...
    <section class="appointment-section">
      <div class="form-container">
        ...
        <form action="patient" method="post">
          ...
          <div class="form-group">
            <label for="phone">Patient Password:</label>
            <input
              type="password"
              id="phone"
              name="patPassword"
          ...
          <div class="form-group">
            <label for="phone">Confirm Patient Password:</label>
            <input
              type="password"
              id="phone"
              name="patConfirmPass"
          ...
          <button type="submit" name="patientForgotPass" class="submit-btn">Submit</button>
        </form>
      </div>
    </section>
